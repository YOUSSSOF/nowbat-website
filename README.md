...
**Live →** [nowbat.ir](https://nowbat.ir) &nbsp;·&nbsp; **Plugin →** [rtl-theme.com/product/nowbat](https://www.rtl-theme.com/product/nowbat/)
...
- Persisted in `localStorage` under `nowbat-theme`

---

## License

MIT — website source only. The Nowbat WordPress plugin itself is a commercial product available at [rtl-theme.com/product/nowbat](https://www.rtl-theme.com/product/nowbat/).
